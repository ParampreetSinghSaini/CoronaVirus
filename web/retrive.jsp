...
<td><%=resultSet.getString("Treatment") %></td>

<td>
   
    <a href ="aive.jsp?email=<%=resultSet.getString("email")%>" class="btn btn-danger">Delete</a> 
    
    <!--<a href ="aive.jsp" class ="btn btn-danger">Delete</a>-->
